    ...
    <tr>
        <td align="center" valign="top">
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
                <tr>
                    <td width="600" height="30" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:12px;line-height:14px;color:#7e7e7e;">Si no puedes visualizar este correo, <a title="Visualiza el mensaje original" href="" target="_blank" style="color:#7e7e7e;">da clic aqu&iacute;</a>.</td>
                </tr>
            </table>
                            ...
                            <tr>
                                ...
                                <td width="528" style="line-height:0px;font-size:0px;">
                                    <table width="528" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="528" height="40" align="left" style="font-family:Helvetica,Arial,Sans-serif;font-size:16px;line-height:18px;color:#0dbff2;"><strong>Bienvenido</strong></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="528" height="40" style="font-family:Helvetica,Arial,Sans-serif;font-size:12px;line-height:16px;color:#000000;text-align:justify;">Por favor haga click en el siguiente enlace para validar su participaci&oacute;n: <a href="{{ URL::to('/registro'); }}" target="blank" style="color:#0dbff2;"></a></td>
                                        </tr>
                                        <tr>
    ...
    <tr><!-- INICIAN LEGALES -->
        <td width="600" style="line-height:0px;font-size:0px;">
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                ...
                <tr>
                    <td width="600" height="18" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:9px;font-weight:bold;line-height:12px;color:#666666;">Este mensaje fue enviado a  por Lottery Popcorn.</td>
                </tr>
                <tr>

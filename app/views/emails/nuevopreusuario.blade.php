    ...
    <tr>
        <td align="center" valign="top">
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
                <tr>
                    <td width="600" height="30" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:12px;line-height:14px;color:#7e7e7e;">Si no puedes visualizar este correo, <a title="Visualiza el mensaje original" href="{{ URL::to('/original'); }}/{{$token}}/{{$jugada}}" target="_blank" style="color:#7e7e7e;">da clic aqu&iacute;</a>.</td>
                </tr>
            </table>
                            ...
                            <tr>
                                ...
                                <td width="528" style="line-height:0px;font-size:0px;">
                                    <table width="528" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td width="528" height="40" style="font-family:Helvetica,Arial,Sans-serif;font-size:12px;line-height:16px;color:#000000;text-align:justify;">Por favor haga click en el siguiente enlace para validar su participaci&oacute;n: <a href="{{ URL::to('/registro'); }}/{{ $token }}/{{ $idePreusuario }}" target="blank" style="color:#0dbff2;">{{ $numeros }}</a></td>
                                        </tr>
                                        <tr>
